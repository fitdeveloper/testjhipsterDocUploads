...
import com.test.myapp.TestjhipsterDocUploadsApp;
import com.test.myapp.domain.Document;
import com.test.myapp.domain.Car;
import com.test.myapp.repository.DocumentRepository;
import com.test.myapp.repository.search.DocumentSearchRepository;
 ...
 */
@SpringBootTest(classes = TestjhipsterDocUploadsApp.class)
...
public class DocumentResourceIT {
     ...
     *
     * @see com.test.myapp.repository.search.DocumentSearchRepositoryMockConfiguration
     */
    @Autowired
