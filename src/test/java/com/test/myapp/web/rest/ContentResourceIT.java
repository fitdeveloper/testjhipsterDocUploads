...
import com.test.myapp.repository.ContentRepository;
import com.test.myapp.repository.search.ContentSearchRepository;
...
public class ContentResourceIT {
     ...
     *
     * @see com.test.myapp.repository.search.ContentSearchRepositoryMockConfiguration
     */
    @Autowired
